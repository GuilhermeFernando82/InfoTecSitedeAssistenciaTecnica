	...
	<div class="bg-contact2" style="background-image: url('images/bg-01.jpg');">
		<div class="container-contact2">
			<div class="wrap-contact2">
				<form class="contact2-form validate-form" method="post" action="logando1.php">
					<span class="contact2-form-title">
						Login Funcionario Administrador
					</span>

					<div class="wrap-input2 validate-input" data-validate="nome">
